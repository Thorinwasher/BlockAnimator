...
public class BlockPlaceAfter1_17_1 implements BlockAnimator<BlockData> {
    ...
    public void blockMove(ImmutableVector3i identifier, Vector3d to, BlockSupplier<BlockData> blockSupplier) {
        BlockDisplayEquivalent fallingBlock = spawnOrGetFallingBlock(identifier, to, blockSupplier);
        fallingBlock.move(to);
    }
    ...
    public void blockPlace(ImmutableVector3i identifier, BlockSupplier<BlockData> blockSupplier) {
        ...
        fallingBlock.move(identifier.asVector3d().add(0.5, 0, 0.5));
        fallingBlock.freeze();
    ...
    public void setTransform(ImmutableVector3i identifier, Matrix4f transform) {
        BlockDisplayEquivalent blockDisplayEquivalent = fallingBlocks.get(identifier);
    }
